// Electonic Life Project from Eloquent JavaScript
//  0. Set-up, common
//  1. Vector
//  2. Grid
//  3. Critter
...
actionTypes.reproduce = function(critter, vector, action) {
    ...
    var dest = this.checkDestination(action, vector);
    var infertile = dest == null ||
        critter.energey <= 2 * baby.energy ||
        this.grid.get(dest) != null;
    if (infertile) {
        return false;
    }
...
function setMapInterval() {
    if(!mapRefreshState) {
        var int = setInterval(refreshMap, 200);
